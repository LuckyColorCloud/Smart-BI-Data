...
public class FileStorageServiceImpl extends ServiceImpl<FileStorageDao, FileStorageEntity> implements FileStorageService {
    ...
    public Result<Object> saveAndStorage(MultipartFile file, String md5, String saveName, Integer sourceId) {
        ...
        try {
            ...
            fileStorageEntity.setFileName(file.getOriginalFilename());
            fileStorageEntity.setFilePath(domain + File.separator + file.getOriginalFilename());
            fileStorageEntity.setSize(file.getSize());
            fileStorageEntity.setFileMd5(md5);
            ...
            //保存文件到目录
            File saveFile = new File(fileStorageEntity.getFilePath());
